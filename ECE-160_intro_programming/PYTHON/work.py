...
class TurtleBot4FirstNode(Node):
    ...
    def __init__(self):
        ...
        # Subscribing to interface buttons topic
        ...
        # Creating a publisher for the /cmd_lightring topic
        # Takes in three arguments
        self.lightring_publisher = self.create_publisher( #Instantiates the publisher
            LightringLeds,                               # message type
            '/cmd_lightring',                            # topic 
            qos_profile_sensor_data)                     # Subscriber
