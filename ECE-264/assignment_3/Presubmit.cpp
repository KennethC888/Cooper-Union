...
void sortDataList(std::list<Data*>& l) {
    constexpr size_t MAX_SIZE = 100000000; // Predefined maximum array size
    static Data* dataArray[MAX_SIZE];     // Pre-allocated static array of pointers

    // Step 1: Populate the array with pointers from the list
    size_t n = 0;
    ...
    // Step 3: Clear the original list and reassemble it
